...
export default function Home(props) {
	let { usersData, articlesData, recentArticles } = props;
					...
					<div className="p-5">
						<div className="flex items-center">
							...
							<div className="font-medium text-blue-500">
								<span>+ </span>
								<animated.span>{todayUsers.value.interpolate((v) => Math.floor(v))}</animated.span>
							</div>
						</div>
					</div>
				...
				<div className="overflow-hidden bg-white rounded-lg shadow">
					<div className="p-5">
						<div className="flex items-center">
							...
							<div className="font-medium text-blue-500">
								<span>+ </span>
								<animated.span>{todayArticles.value.interpolate((v) => Math.floor(v))}</animated.span>
							</div>
						</div>
					</div>
					...
					<div className="px-5 py-3 bg-gray-50">
						<div className="text-sm">
							<Link to="articles?type=all" className="font-medium text-blue-500 hover:text-blue-700">
								View all
							</Link>
						</div>
					</div>
