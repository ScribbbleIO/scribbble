...
export default function ScribbbleSmall() {
	return (
		<span
			className="relative inline-flex items-end font-serif text-gray-700 dark:text-gray-200"
			style={{ fontSize: '20rem' }}
			aria-label="scribbble"
		>
			<svg className="flex-none text-blue-500" viewBox="0 0 8.364 13.476" width="0.8em">
				<path
					fill="currentColor"
			...
			<svg
				...
				style={{ marginLeft: '0.1em', marginBottom: '0.095em' }}
