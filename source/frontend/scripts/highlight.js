	...
	return (function (t) {
		...
		function b(e, t, a, s) {
			...
			try {
				...
				if (l)
					return { illegal: !1, relevance: 0, value: k(o), emitter: M, language: e, top: R, errorRaised: n };
				throw n;
			}
		}
		function v(e, n) {
		...
		Object.assign(t, {
			...
			registerLanguage: function (e, n) {
				...
				try {
					...
					if ((console.error("Language definition for '{}' could not be registered.".replace('{}', e)), !l))
						throw n;
					console.error(n), (r = h);
				}
				r.name || (r.name = e),
